...
In conclusion \textit{McNemar's Test} evaluates cross information by comparing the results of
evaluating both systems on exactly the same sample. \textit{Bootstrapping} differs on this
point because each sample is evaluated independently for each system, allowing a complementary
analysis to determine the statistic significance of the results.
