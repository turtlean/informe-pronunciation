...
A disadvantage of McNemar's, however, is that unlike Bootstrapping, it assumes that the samples are
independent, and that condition does not hold in the current work.

A complementary analysis using both different techniques is carried out in the experiment section
