In this section we describe the chosen features for the current study. The features can be classified in two different categories: \textcolor{red}{frame-level features and
