...
\textcolor{red}
{Results are depicted in \ref{fig:legendreTunning}, which shows the variation of the
...
\textcolor{red}{
	As it is described in equation \ref{eq:svm}, a labeled dataset
	...
	\end{equation}
	The process for computing the features combination vectors can be alternatively
...
\textcolor{red}{
	An initial exploratory experiment showed that no further gains are obtained when using
	proportions higher than 1.0 for the dynamic features in neither features nor score combinations.
}
