...
\textcolor{red}{
Even though training a system with a combination of the three types of features:
...
could have lead to overfitting the final model. Because of these reasons, and the fact
that we weren't expecting significant gains in combining both types of dynamic features
that already model the same aspects, the idea of combining the three features was discarded.
}
